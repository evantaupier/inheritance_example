# represents emplyee data as an array
...
# represent data employee as a hash
...
# represents emplyees as a class instance
...
employee2 = Employee.new("Damilo", "Campos", 70000, true)
